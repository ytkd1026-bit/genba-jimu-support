...
const DEMO_EXPENSE_BREAKDOWN: ExpenseBreakdown[] = [
            ...
            <>
              ...
              <div className="rounded-2xl bg-[#8B4A3C] p-4 shadow-sm text-white">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <p className="text-lg font-bold">{yen(DEMO_SUMMARY.sales)}</p>
                  </div>
                  <div>
                    <p className="text-xs text-amber-100">支出合計</p>
                    <p className="text-lg font-bold">{yen(DEMO_SUMMARY.expenses)}</p>
                  </div>
                  <div>
                    <p className="text-xs text-amber-100">粗利</p>
                    <p className="text-lg font-bold">{yen(DEMO_SUMMARY.grossProfit)}</p>
                  </div>
                  <div>
                    <p className="text-xs text-amber-100">粗利率</p>
                    <p className="text-lg font-bold">{DEMO_SUMMARY.grossMargin}%</p>
                  </div>
                </div>
                <div className="mt-3 grid grid-cols-2 gap-3 border-t border-white/20 pt-3">
                  <div className="rounded-xl bg-amber-600/40 px-3 py-2">
                    ...
                    <p className="text-base font-bold">{yen(DEMO_SUMMARY.uninvoiced)}</p>
                  </div>
                  <div className="rounded-xl bg-amber-600/40 px-3 py-2">
                    <p className="text-xs text-amber-100">未入金金額</p>
                    <p className="text-base font-bold">{yen(DEMO_SUMMARY.unpaid)}</p>
                  </div>
                </div>
              </div>
              ...
              >
                <div className="text-left">
                  ...
                  <p className="mt-0.5 text-xs text-stone-400">
                    {yen(DEMO_SUMMARY.sales)}　請求済み・未請求・入金済み・未入金
                  </p>
                </div>
              ...
              >
                <div className="text-left">
                  ...
                  <p className="mt-0.5 text-xs text-stone-400">
                    {yen(DEMO_SUMMARY.expenses)}　材料費・外注費・経費など
                  </p>
                </div>
              ...
              <div className="rounded-2xl bg-white p-4 shadow-sm">
                ...
                <ul className="space-y-2">
                  {DEMO_EXPENSE_BREAKDOWN.map((item) => (
                  ...
                  <li className="flex items-center justify-between border-t border-stone-100 pt-2">
                    ...
                    <span className="text-sm font-bold text-[#8B4A3C]">
                      {yen(DEMO_EXPENSE_BREAKDOWN.reduce((s, e) => s + e.amount, 0))}
                    </span>
                  </li>
                </ul>
              </div>
